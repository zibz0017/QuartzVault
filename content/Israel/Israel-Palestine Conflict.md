...
1. During the 1970s and 1980s Israel was largely indifferent or perhaps even supportive of the precursor organization to Hamas (called Mujama al-Islamiya Islamic), calling them a charity organization. [^1]
...
2. The legality of using white phosphorus is tricky. It seems that it is technically legal to use but it is difficult to do so in a legal way. {<font color="#ff0000">Need source</font>}
	<font color="#f79646">Counter:</font> Israel is using it for illumination purposes which is legal. [^2]
	<font color="#9bbb59">Counter:</font> Israel has been sometimes using white phosphorus during the day, so it would seem that at least sometimes they are not using white phosphorus for illumination purposes. [^2]
...
2. Some of the quotes may be referring to Hamas particularly, even if they say "Gaza" or "Gazans" (the same way a Ukrainian might discuss fighting the "Russians" even though he is only talking about the Russian army, not the Russian people).
	<font color="#f79646">Counter:</font> It is not uncommon for leaders to use very hawkish language even if they actually do not carry out such hawkish policy. They are playing politics and so they may need to make certain strong statements to maintain the support of the people. {need to get some examples} [^2]
### Turning off Water
...
2. This may be a war crime, although this might not count as genocide (unless people started dying from the lack of water. Not sure about this point, though.) {<font color="#ff0000">Need source</font>}
### 2014 Four Arab Children on a Beach Incident:
1. There was an incident in 2014 where there were four Arabic children playing on a beach who were killed by an Israel drone attack. [^2]
2. There were no potential Hamas operatives in the area. [^2]
3. The kids were around 10 years old. [^2]
4. This attack occurred near a hotel where there were a lot of international press staying so the incident was widely covered. [^2]
	<font color="#f79646">Counter:</font> An Israeli investigation found that the beach was used by Hamas naval commandos. Israel had previously struck that same beach as recently as the previous day. That part of the beach was specifically fenced off because it was being used for terrorist activity.[^2]
...
1. Israeli doctrine to respond with disproportionate response to attacks to dissuade future attacks. {<font color="#ff0000">I’m not sure if the point is to kill civilians as well to try to get the civilian population to turn on the terrorists using their village as a base of operations to target Israel, or if this takes the assumption that the village where the attacks are coming from have many terrorists as well as weapons and ammunitions stored there and so it is assessed as a military target worth taking out despite the civilian casualties. Also, is this doctrine still being used by Israel now?</font>}[^3]
	1. <font color="#f79646">Counter:</font> Israel considers it worth it to kill the civilians to save the lives of Israeli civilians.
	2. <font color="#9bbb59">Counter:</font> Isn’t that basically what terrorism is? You attack innocent civilians for the sake of achieving political aims.
	3. <font color="#f79646">Counter:</font> Israel is attempting to save lives by doing this. Perhaps this can be compared to the American bombings of Hiroshima and Nagisaki. Those bombings probably saved hundreds of thousands if not millions of lives.[^4] And this can be even more justified as these villages are launching attacks at Israel as opposed to Hiroshima and Nagisaki that were only tangentially involved in the war {<font color="#ff0000">I assume that there was production in those cities. I should find out if that is true.</font>}
	4. <font color="#f79646">Counter:</font> The people there likely support the attacks on Israel. (This is not a stand alone reason. It stands on top of another reason.)
### Killing aid workers

1. In the 2023 Gaza War, Israel has killed around 200 aid workers (by late March 2023).[^5]
	1. <font color="#f79646">Counter:</font> some of those aid workers were terrorists. {<font color="#ff0000">Need source</font>}
	2. <font color="#f79646">Counter:</font> Hamas has used UNRWA buildings, hospitals, schools, and ambulances to hold and transport ammunition. That can reasonably lead to the death of aid workers. {<font color="#ff0000">Need source</font>}
	3. <font color="#f79646">Possible counter:</font> What is the ratio of aid workers to civilian population? It might be much higher here than other places because of organizations like UNRWA which have a large presence. As such, if Israel deems that a certain attack has a reasonable ratio of damage to enemies versus civilians and goes ahead with it, it is more likely that some of those people are aid workers. {<font color="#ff0000">Need source</font>}
	...
	5. <font color="#f79646">Possible counter (to point 4):</font> That would only apply if Israel is consistently killing aid workers while they are delivering aid. If they are largely killed when they are not, this would not apply.
