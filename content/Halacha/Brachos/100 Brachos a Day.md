...
## שבת
1. On שבת, we have four shemona esreis of seven brachos a piece (7 * 4 = 28) instead of the usual three shemona esreis with 19 brachos each, puting us down 29 brachos (57 - 28 = 29). We also miss out on Yiru eineinu (1) and brachos on tefilin (2).[^6]
...
## Yom טוב
1. Yom טוב is not explicitly discussed but it would seem that if one does not have a third meal, then the cheshbon would come out that the person would be missing 8 brachos compared to the [[#^362d64|87 on שבת]], bringing the total down to 79.[^5]
2. In addition, as [[#^ae15e7|discussed]], 87 on שבת assumes that one bentches on a cup of wine. If one does not do, that, they are missing an additional 6 brachos. So on yom טוב, one would be missing an additional 4 (as there are only 2 meals), bringing the total down to 75.[^5]
